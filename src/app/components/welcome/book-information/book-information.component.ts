        ...
        >
          <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div
                class="validacion"
                *ngIf="
                  editBookForm.get('isbn')?.hasError('required') &&
          ...
          <div class="mb-3">
            ...
            <div
              class="validacion"
              *ngIf="
                editBookForm.get('publish_year')?.hasError('required') &&
                editBookForm.get('publish_year')?.touched
              "
            >
              Clave obligatorio
            </div>
          ...
          <div class="mb-3">
            ...
            <div
              class="validacion"
              *ngIf="
                editBookForm.get('copies')?.hasError('required') &&
                editBookForm.get('copies')?.touched
              "
            >
              Cantidad de Copias obligatorio
            </div>
          </div>
          ...
          <div class="mb-3">
            ...
            <div
              class="validacion"
              *ngIf="
                editBookForm.get('topics')?.hasError('required') &&
                editBookForm.get('topics')?.touched
              "
            >
              Topics obligatorio
            </div>
          ...
          <div class="d-flex justify-content-end">
            ...
            >
              <i class="bi bi-person-plus"></i>Editar
            </button>
          </div>
        </form>
      </section>
...
export default class BookInformationComponent {
  ...
  editar() {
    ...
    this.authService
      .updateBook(this.foundBook.id, editedBook)
      .subscribe((data) => {
